...
USER_1 = int(input("Player one choose Character: 0 = Stickman, 1= Pizza Guy, 2 = Vincent, 3= Disablo\n"))
USER_2 = int(input("Player two choose Character: 0 = Stickman, 1= Pizza Guy, 2 = Vincent, 3= Disablo\n"))
